	...
	return (
		<aside>
			<ul className="space-y-2">
				<li>
					<a
						className="flex items-center space-x-2 px-5 py-3.5 rounded-lg bg-primary hover:bg-primary text-black"
						href="#"
					>
				...
				<li>
					<a
						className="flex items-center space-x-2 px-5 py-3.5 rounded-lg hover:bg-primary"
						href="#"
					>
